 ...
 *
 * @type {BadSigVerifyExampleCloverConnectorListener2}
 */
var BadSigVerifyExampleCloverConnectorListener2 = function (cloverConnector, progressinfoCallback) {
    ExampleCloverConnectorListener.call(this, cloverConnector, progressinfoCallback);
    this.cloverConnector = cloverConnector;
    this.progressinfoCallback = progressinfoCallback;
};

BadSigVerifyExampleCloverConnectorListener2.prototype = Object.create(ExampleCloverConnectorListener.prototype);
 ...
 * @return void
 */
BadSigVerifyExampleCloverConnectorListener2.prototype.onDeviceError = function(deviceErrorEvent) {
 ...
 * @type {TestBase}
 */
TestBadSigVerify2 = function (configUrl, friendlyName, progressinfoCallback) {
    TestBase.call(this, configUrl, friendlyName, progressinfoCallback);
};

TestBadSigVerify2.prototype = Object.create(TestBase.prototype);
TestBadSigVerify2.prototype.constructor = TestBadSigVerify2;

TestBadSigVerify2.prototype.getCloverConnectorListener = function (cloverConnector) {
    return new BadSigVerifyExampleCloverConnectorListener2(cloverConnector, this.progressinfoCallback);
};
 ...
 */
TestBase.TestBadSigVerify2 = function(configUrl, configFile, progressinfoCallback) {
    var testObj = new TestBadSigVerify2(configUrl, configFile, progressinfoCallback);
    testObj.test();
};

if ('undefined' !== typeof module) {
    module.exports = TestBadSigVerify2;
}
