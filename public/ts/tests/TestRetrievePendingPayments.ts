...
export class TestRetrievePendingPayments extends TestBase2 {
    ...
    public getCloverConnectorListener(cloverConnector: Clover.CloverConnector, progressInfoCallback: any): sdk.remotepay.ICloverConnectorListener {
        let connectorListener: TestRetrievePendingPayments.CloverConnectorListener = new TestRetrievePendingPayments.CloverConnectorListener(cloverConnector, progressInfoCallback);
        return connectorListener;
    }
}

export namespace TestRetrievePendingPayments {
    export class CloverConnectorListener extends ExampleCloverConnectorListener {
        ...
        protected startTest(): void {
             ...
             */
            this.displayMessage({message: "RetrievePendingPayments"});
