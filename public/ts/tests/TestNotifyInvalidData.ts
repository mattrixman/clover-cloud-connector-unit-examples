...
export class TestNotifyInvalidData extends TestBase2 {
    ...
    public getCloverConnectorListener(cloverConnector: Clover.CloverConnector, progressInfoCallback: any): sdk.remotepay.ICloverConnectorListener {
        let connectorListener: TestNotifyInvalidData.CloverConnectorListener = new TestNotifyInvalidData.CloverConnectorListener(cloverConnector, progressInfoCallback);
        return connectorListener;
    }
}

export namespace TestNotifyInvalidData {
    export class CloverConnectorListener extends ExampleCloverConnectorListener {
        ...
        protected startTest(): void {
             ...
             */
            this.displayMessage({message: "Running notifyInvalidData"});
            (<Clover.CloverConnector>this.cloverConnector).notifyInvalidData("Testing message for notifyInvalidData");
            setTimeout(function () {
