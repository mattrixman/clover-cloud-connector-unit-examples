...
export {TestImagePrint_6} from "./TestImagePrint_6";
export {TestImagePrint_7} from "./TestImagePrint_7";
export {TestImagePrint_8} from "./TestImagePrint_8";

export {TestImageUrlPrint} from "./TestImageUrlPrint"
export {TestImageUrlPrint_01} from "./TestImageUrlPrint_01"
...
// no point in including TestPrint because it does not have any settings associated with it.
export {TestPrint_Image_1} from "./TestPrint_Image_1";
export {TestPrint_Image_2} from "./TestPrint_Image_2";
export {TestPrint_Image_3} from "./TestPrint_Image_3";
export {TestPrint_Image_4} from "./TestPrint_Image_4";
export {TestPrint_Image_5} from "./TestPrint_Image_5";
...
export {TestPrint_Url_3} from "./TestPrint_Url_3";
export {TestPrint_Url_4} from "./TestPrint_Url_4";
