...
export class TestResetResponse_end_START extends TestBase2 {
    ...
    public getName(): string {
        return "Test resetting the device after a sale is started, and getting a response (End of start payment)";
    }
    ...
    public getCloverConnectorListener(cloverConnector: Clover.CloverConnector, progressInfoCallback: any): sdk.remotepay.ICloverConnectorListener {
        let connectorListener: TestResetResponse_end_START.CloverConnectorListener = new TestResetResponse_end_START.CloverConnectorListener(cloverConnector, progressInfoCallback);
        return connectorListener;
    }
}

export namespace TestResetResponse_end_START {
    export class CloverConnectorListener extends ExampleCloverConnectorListener {
        ...
        protected getTestName(): string {
            return "Test resetting the device after a sale is started (End of start payment)";
        }
