...
export class TestAuth extends TestBase2 {
    ...
    public getCloverConnectorListener(cloverConnector: Clover.CloverConnector, progressInfoCallback: any): sdk.remotepay.ICloverConnectorListener {
        let connectorListener: TestAuth.CloverConnectorListener = new TestAuth.CloverConnectorListener(cloverConnector, progressInfoCallback);
