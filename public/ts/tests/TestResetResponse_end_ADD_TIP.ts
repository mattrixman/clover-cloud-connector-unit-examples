...
export class TestResetResponse_end_ADD_TIP extends TestBase2 {
    ...
    public getName(): string {
        return "Test resetting the device after a sale is started, and getting a response (End of tip screen)";
    }
    ...
    public getCloverConnectorListener(cloverConnector: Clover.CloverConnector, progressInfoCallback: any): sdk.remotepay.ICloverConnectorListener {
        let connectorListener: TestResetResponse_end_ADD_TIP.CloverConnectorListener = new TestResetResponse_end_ADD_TIP.CloverConnectorListener(cloverConnector, progressInfoCallback);
        return connectorListener;
    }
}

export namespace TestResetResponse_end_ADD_TIP {
    export class CloverConnectorListener extends ExampleCloverConnectorListener {
        ...
        protected getTestName(): string {
            return "Test resetting the device after a sale is started (End of tip screen)";
        }
